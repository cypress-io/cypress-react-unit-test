...
[test-react-hooks-animations](https://github.com/bahmutov/test-react-hooks-animations) | ![cypress-react-unit-test used in test-react-hooks-animations version](https://img.shields.io/badge/cypress--react--unit--test-4.16.0-brightgreen) | Testing React springs fun blob animation
[test-mdx-example](https://github.com/bahmutov/test-mdx-example) | ![cypress-react-unit-test used in test-mdx-example version](https://img.shields.io/badge/cypress--react--unit--test-4.16.0-brightgreen) | Example testing MDX components using Cypress
...
[test-xstate-react](https://github.com/bahmutov/test-xstate-react) | ![cypress-react-unit-test used in test-xstate-react version](https://img.shields.io/badge/cypress--react--unit--test-4.16.0-brightgreen) | XState component testing using Cypress
[test-react-router-v5](https://github.com/bahmutov/test-react-router-v5) | ![cypress-react-unit-test used in test-react-router-v5 version](https://img.shields.io/badge/cypress--react--unit--test-4.16.0-brightgreen) | A few tests of React Router v5
[test-material-ui](https://github.com/bahmutov/test-material-ui) | ![cypress-react-unit-test used in test-material-ui version](https://img.shields.io/badge/cypress--react--unit--test-4.16.0-brightgreen) | Testing Material UI components: date pickers, lists, autocomplete
[test-d3-react-gauge](https://github.com/bahmutov/test-d3-react-gauge) | ![cypress-react-unit-test used in test-d3-react-gauge version](https://img.shields.io/badge/cypress--react--unit--test-4.16.0-brightgreen) | Testing React D3 gauges
...
[react-loading-skeleton](https://github.com/bahmutov/react-loading-skeleton) | ![cypress-react-unit-test used in react-loading-skeleton version](https://img.shields.io/badge/cypress--react--unit--test-4.16.0-brightgreen) | One to one Storybook tests for React skeleton components. Uses local `.babelrc` settings without Webpack config
[test-swr](https://github.com/bahmutov/test-swr) | ![cypress-react-unit-test used in test-swr version](https://img.shields.io/badge/cypress--react--unit--test-4.16.0-brightgreen) | Component test for [Zeit SWR](https://github.com/zeit/swr) hooks for remote data fetching
