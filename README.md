...
--- | --- | ---
[try-cra-with-unit-test](https://github.com/bahmutov/try-cra-with-unit-test) | ![cypress-react-unit-test used in try-cra-with-unit-test short](https://img.shields.io/badge/4.1.7-brightgreen) | Hello world initialized with CRAv3
...
[test-apollo](https://github.com/bahmutov/test-apollo) | ![cypress-react-unit-test used in test-apollo short](https://img.shields.io/badge/4.10.0-brightgreen) | Component testing an application that uses Apollo GraphQL library
...
[emoji-search](https://github.com/bahmutov/emoji-search) | ![cypress-react-unit-test used in emoji-search short](https://img.shields.io/badge/4.0.1-brightgreen) | Quick component test for a fork of emoji-search
[test-custom-error-boundary](https://github.com/bahmutov/test-custom-error-boundary) | ![cypress-react-unit-test used in test-custom-error-boundary short](https://img.shields.io/badge/4.1.0-brightgreen) | Play with a component that implements error boundary
[Jscrambler-Webpack-React](https://github.com/bahmutov/Jscrambler-Webpack-React) | ![cypress-react-unit-test used in Jscrambler-Webpack-React short](https://img.shields.io/badge/4.1.0-brightgreen) | Example project with its own Webpack config file
[bahmutov/integration-tests](https://github.com/bahmutov/integration-tests) | ![cypress-react-unit-test used in integration-tests short](https://img.shields.io/badge/4.2.1-brightgreen) | Example based on blog post [React Integration Testing: Greater Coverage, Fewer Tests](https://css-tricks.com/react-integration-testing-greater-coverage-fewer-tests/)
[mobx-react-typescript-boilerplate](https://github.com/bahmutov/mobx-react-typescript-boilerplate) | ![cypress-react-unit-test used in mobx-react-typescript-boilerplate short](https://img.shields.io/badge/4.8.0-brightgreen) | Fork of the official Mobx example, shows clock control
[bahmutov/test-react-hook-form](https://github.com/bahmutov/test-react-hook-form) | ![cypress-react-unit-test used in test-react-hook-form short](https://img.shields.io/badge/4.2.2-brightgreen) | Testing forms created using [react-hook-form](https://github.com/react-hook-form/react-hook-form)
[bahmutov/react-with-rollup](https://github.com/bahmutov/react-with-rollup) | ![cypress-react-unit-test used in react-with-rollup short](https://img.shields.io/badge/4.2.3-brightgreen) | Testing a React application bundled with Rollup by using [@bahmutov/cy-rollup](https://github.com/bahmutov/cy-rollup) preprocessor
[bahmutov/testing-react-example](https://github.com/bahmutov/testing-react-example) | ![cypress-react-unit-test used in testing-react-example short](https://img.shields.io/badge/4.2.3-brightgreen) | Described in blog post [Test React Component with cypress-react-unit-test Example](https://dev.to/bahmutov/test-react-component-with-cypress-react-unit-test-example-4d99)
[ejected-react-scripts-example](https://github.com/bahmutov/ejected-react-scripts-example) | ![cypress-react-unit-test used in ejected-react-scripts-example short](https://img.shields.io/badge/4.3.1-brightgreen) | Using component testing after ejecting `react-scripts`
[tic-tac-toe](https://github.com/bahmutov/react-tic-tac-toe-example) | ![cypress-react-unit-test used in react-tic-tac-toe-example short](https://img.shields.io/badge/4.4.2-brightgreen) | Component and unit tests for Tic-Tac-Toe, read [Tic-Tac-Toe Component Tests](https://glebbahmutov.com/blog/tic-tac-toe-component-tests/)
[react-hooks-file-upload](https://github.com/bahmutov/react-hooks-file-upload) | ![cypress-react-unit-test used in react-hooks-file-upload short](https://img.shields.io/badge/4.7.0-brightgreen) | Upload a file from the component while stubbing the server
[react-query-example](https://github.com/bahmutov/react-query-example) | ![cypress-react-unit-test used in react-query-example short](https://img.shields.io/badge/4.8.0-brightgreen) | Quick test example for components that use `react-query` with mock clock control
<!-- prettier-ignore-end -->
