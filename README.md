...
[test-redux-examples](https://github.com/bahmutov/test-redux-examples) | ![cypress-react-unit-test used in test-redux-examples version](https://img.shields.io/badge/cypress--react--unit--test-3.2.0-brightgreen) | Example apps copies from official Redux repo and tested as components
[test-react-hooks-animations](https://github.com/bahmutov/test-react-hooks-animations) | ![cypress-react-unit-test used in test-react-hooks-animations version](https://img.shields.io/badge/cypress--react--unit--test-3.0.0-cypress-mount-mode.9-brightgreen) | Testing React springs fun blob animation
[test-mdx-example](https://github.com/bahmutov/test-mdx-example) | ![cypress-react-unit-test used in test-mdx-example version](https://img.shields.io/badge/cypress--react--unit--test-3.0.0-cypress-mount-mode.13-brightgreen) | Example testing MDX components using Cypress
[test-apollo](https://github.com/bahmutov/test-apollo) | ![cypress-react-unit-test used in test-apollo version](https://img.shields.io/badge/cypress--react--unit--test-4.10.0-brightgreen) | Component testing an application that uses Apollo GraphQL library
[test-xstate-react](https://github.com/bahmutov/test-xstate-react) | ![cypress-react-unit-test used in test-xstate-react version](https://img.shields.io/badge/cypress--react--unit--test-3.0.0-cypress-mount-mode.13-brightgreen) | XState component testing using Cypress
[test-react-router-v5](https://github.com/bahmutov/test-react-router-v5) | ![cypress-react-unit-test used in test-react-router-v5 version](https://img.shields.io/badge/cypress--react--unit--test-3.0.0-cypress-mount-mode.13-brightgreen) | A few tests of React Router v5
[test-material-ui](https://github.com/bahmutov/test-material-ui) | ![cypress-react-unit-test used in test-material-ui version](https://img.shields.io/badge/cypress--react--unit--test-3.0.0-cypress-mount-mode.14-brightgreen) | Testing Material UI components: date pickers, lists, autocomplete
[test-d3-react-gauge](https://github.com/bahmutov/test-d3-react-gauge) | ![cypress-react-unit-test used in test-d3-react-gauge version](https://img.shields.io/badge/cypress--react--unit--test-3.0.0-cypress-mount-mode.14-brightgreen) | Testing React D3 gauges
[storybook-code-coverage](https://github.com/bahmutov/storybook-code-coverage) | ![cypress-react-unit-test used in storybook-code-coverage version](https://img.shields.io/badge/cypress--react--unit--test-4.0.1-brightgreen) | Example app where we get 100% code coverage easily with a single integration spec and a few component specs, replacing [several tools](https://dev.to/penx/combining-storybook-cypress-and-jest-code-coverage-4pa5)
[react-loading-skeleton](https://github.com/bahmutov/react-loading-skeleton) | ![cypress-react-unit-test used in react-loading-skeleton version](https://img.shields.io/badge/cypress--react--unit--test-3.0.0-cypress-mount-mode.20-brightgreen) | One to one Storybook tests for React skeleton components. Uses local `.babelrc` settings without Webpack config
[test-swr](https://github.com/bahmutov/test-swr) | ![cypress-react-unit-test used in test-swr version](https://img.shields.io/badge/cypress--react--unit--test-3.0.0-cypress-mount-mode.22-brightgreen) | Component test for [Zeit SWR](https://github.com/zeit/swr) hooks for remote data fetching
[emoji-search](https://github.com/bahmutov/emoji-search) | ![cypress-react-unit-test used in emoji-search version](https://img.shields.io/badge/cypress--react--unit--test-4.0.1-brightgreen) | Quick component test for a fork of emoji-search
[test-custom-error-boundary](https://github.com/bahmutov/test-custom-error-boundary) | ![cypress-react-unit-test used in test-custom-error-boundary version](https://img.shields.io/badge/cypress--react--unit--test-4.1.0-brightgreen) | Play with a component that implements error boundary
[Jscrambler-Webpack-React](https://github.com/bahmutov/Jscrambler-Webpack-React) | ![cypress-react-unit-test used in Jscrambler-Webpack-React version](https://img.shields.io/badge/cypress--react--unit--test-4.1.0-brightgreen) | Example project with its own Webpack config file
[bahmutov/integration-tests](https://github.com/bahmutov/integration-tests) | ![cypress-react-unit-test used in integration-tests version](https://img.shields.io/badge/cypress--react--unit--test-4.2.1-brightgreen) | Example based on blog post [React Integration Testing: Greater Coverage, Fewer Tests](https://css-tricks.com/react-integration-testing-greater-coverage-fewer-tests/)
[mobx-react-typescript-boilerplate](https://github.com/bahmutov/mobx-react-typescript-boilerplate) | ![cypress-react-unit-test used in mobx-react-typescript-boilerplate version](https://img.shields.io/badge/cypress--react--unit--test-4.8.0-brightgreen) | Fork of the official Mobx example, shows clock control
[bahmutov/test-react-hook-form](https://github.com/bahmutov/test-react-hook-form) | ![cypress-react-unit-test used in test-react-hook-form version](https://img.shields.io/badge/cypress--react--unit--test-4.2.2-brightgreen) | Testing forms created using [react-hook-form](https://github.com/react-hook-form/react-hook-form)
[bahmutov/react-with-rollup](https://github.com/bahmutov/react-with-rollup) | ![cypress-react-unit-test used in react-with-rollup version](https://img.shields.io/badge/cypress--react--unit--test-4.2.3-brightgreen) | Testing a React application bundled with Rollup by using [@bahmutov/cy-rollup](https://github.com/bahmutov/cy-rollup) preprocessor
[bahmutov/testing-react-example](https://github.com/bahmutov/testing-react-example) | ![cypress-react-unit-test used in testing-react-example version](https://img.shields.io/badge/cypress--react--unit--test-4.2.3-brightgreen) | Described in blog post [Test React Component with cypress-react-unit-test Example](https://dev.to/bahmutov/test-react-component-with-cypress-react-unit-test-example-4d99)
[ejected-react-scripts-example](https://github.com/bahmutov/ejected-react-scripts-example) | ![cypress-react-unit-test used in ejected-react-scripts-example version](https://img.shields.io/badge/cypress--react--unit--test-4.3.1-brightgreen) | Using component testing after ejecting `react-scripts`
[tic-tac-toe](https://github.com/bahmutov/react-tic-tac-toe-example) | ![cypress-react-unit-test used in react-tic-tac-toe-example version](https://img.shields.io/badge/cypress--react--unit--test-4.4.2-brightgreen) | Component and unit tests for Tic-Tac-Toe, read [Tic-Tac-Toe Component Tests](https://glebbahmutov.com/blog/tic-tac-toe-component-tests/)
[react-hooks-file-upload](https://github.com/bahmutov/react-hooks-file-upload) | ![cypress-react-unit-test used in react-hooks-file-upload version](https://img.shields.io/badge/cypress--react--unit--test-4.7.0-brightgreen) | Upload a file from the component while stubbing the server
[react-query-example](https://github.com/bahmutov/react-query-example) | ![cypress-react-unit-test used in react-query-example version](https://img.shields.io/badge/cypress--react--unit--test-4.8.0-brightgreen) | Quick test example for components that use `react-query` with mock clock control
<!-- prettier-ignore-end -->
